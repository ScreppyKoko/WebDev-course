...
document.querySelector('.b-2').addEventListener('click', () => {
    ...
    sum1.apply(document.querySelector('.out-4'), [2, 4]);
});

//! bind
const f5 = f1.bind(document.querySelector('.out-5'));
// f5();
// f5();
// f5();
...
document.querySelector('.b-6').addEventListener('click', () => {
    sum4(5, 8, 10);  //! аргументы 8 и 10 перезатерты, т.к. при вызове переданы аргументы 100(теперь a) и 200(тепперь b), они подставляютя в начало 
});
