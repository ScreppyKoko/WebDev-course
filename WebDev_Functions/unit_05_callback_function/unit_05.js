...
let res4;
res4 = ar3.filter(item => typeof item === 'number' && item < 4); // сюда в скобки дописываете стрелочную функцию
...
let res8;
res8 = ar7.every(elem => elem > 4 && typeof elem === 'number'); // сюда в скобки дописываете стрелочную функцию
...
res10 = ar9.some(elem => typeof elem === 'number' && elem < 6);// сюда в скобки дописываете стрелочную функцию
