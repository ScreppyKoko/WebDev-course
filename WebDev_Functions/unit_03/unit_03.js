function taskCompletion(btn, block, func) {
    document.querySelector(btn).addEventListener('click', () => {
        document.querySelector(block).textContent = func;
    });
...
taskCompletion('.b-1', '.out-1', t1(120,140));
...
function t2(a, b) {
    if (a > b) return a;
    else if (a === b) return 'равны';
    else return b;
}

taskCompletion('.b-2', '.out-2', t2(140, -142));
// document.querySelector('.b-2').addEventListener('click', () => {
//     document.querySelector('.out-2').textContent = t2(-140, -142);
// });
...
// taskCompletion('.b-3', '.out-3', t3());   //! не работает 
...
// taskCompletion('.b-4', '.out-4', t4());   //! не работает 
...
// Task 5
// Напишите функцию t5, которая получает из s51 число, из s52 знак и из s53 число и возвращает результат математической операции над этими числами с этим знаком. Т.е. возвращает или 
// сумму чисел, или произведение, или разность или деление.


function t5() {
    const numOne = +document.querySelector('.s51').value;
    const val = document.querySelector('.s52').value;
    const numTwo = +document.querySelector('.s53').value;
    if (val === '+') return numOne + numTwo;
    else if (val === '-') return numOne - numTwo;
    else if (val === '/') return numOne / numTwo;
    else if  (val === '*') return numOne * numTwo;
    else return false;
}

// taskCompletion('.b-5', '.out-5', t5());  //! не работает 
...
// Task 6
// Напишите функцию, которая принимает три аргумента: num1, num2 - числа и sign - строку знак операции. sign может быть равен '+', '-', '/', '*'. 
// В зависимости от знака функция должна возвращать результат выбранной операции над числами. Например передали числа 10 и 5 и знак '/'. Функция должна возвратить 2.
...
function t8(num, method) {
    ...
    else if (method === 'ceil') return Math.ceil(num);
    else return false;
}
...
document.querySelector('.b-9').addEventListener('click', function () {
    document.querySelector('.out-9').textContent = t9(3, 4);
});
...
document.querySelector('.b-13').addEventListener('click', function () {
    document.querySelector('.out-13').textContent = t13(100.571, 120);
});


// Task 14
// Напишите функцию, которая возвращает строку в виде rgb(xxx,yyy,zzz) где xxx, yyy, zzz случайные целые числа в диапазонах от 0 до 255. В строке не должно быть пробелов. 
// Для генерации случайных чисел используйте функцию t13.

function t14() {
    const rgbColor = `rgb(${t13(0, 255)}, ${t13(0, 255)}, ${t13(0, 255)})`;
    return rgbColor;
}
