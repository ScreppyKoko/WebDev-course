...
function f5() {
    ...
    if (div4.classList.contains('bg-orange')) {
        div5.textContent = true;
    } else {
        div5.textContent = false;
    }
}
...
function f11() {
    ...
    document.querySelector('.out-11').appendChild(newDiv);
}
...
function f12() {
    ...
    document.querySelector('.out-12').appendChild(newDiv);
}
...
function f13() {
    ...
    document.querySelector('.out-13').appendChild(newDiv);
...
function f14() {
    ...
    newDiv.classList.add('bg-orange');
    document.querySelector('.out-14').appendChild(newDiv);
}
