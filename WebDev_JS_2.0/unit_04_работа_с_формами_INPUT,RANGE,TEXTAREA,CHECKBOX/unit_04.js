...
function f4() {
    const inputCheckbox = document.querySelector('.i-4');
...
function f5() {
    const inputCheckbox = document.querySelector('.i-5');
    const output = document.querySelector('.out-5');
    if (inputCheckbox.checked) {
        output.textContent = inputCheckbox.value;
    } else {
        output.textContent = false;
    }
}
...
function f7() {
    ...
    const passLength = document.querySelector('.out-72');

    document.querySelector('.out-71').textContent = input;
...
// Task 8.
// При нажатии кнопки .b-8 запускается функция f8. Функция с помощью innerHTML создает в .out-8 новый div с классом "js2" и текстом "new div". 
//Нажали несколько раз? Создаем несколько раз!  

function f8() {
    document.querySelector('.out-8').innerHTML = '<div class="js2">new div</div>';
    // речь о повторном создании элемента по нажатию кнопки? или нужно было применять createElement??
}
...
function f9() {
    const inpRadio = document.querySelector('.r-9');
    const output = document.querySelector('.out-9');
    if (inpRadio.checked) {
        output.textContent = inpRadio.value;
    } else {
        output.textContent = false;
    }
}
...
document.querySelector('.i-13').oninput = f13; // задействовали событие oninput
...
function f15() {
    ...
    document.querySelector('.t-15').value = input;  // работает и с textContent и с innerHTML  
