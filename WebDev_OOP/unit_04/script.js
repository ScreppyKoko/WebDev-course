...
const exampleList = new List(['one', 'two', 'three', 'four']);
exampleList.render();
...
const exampleList2 = new List2(['1', '2', '3', '4'], 'red');
exampleList2.render();
...
const exampleList3 = new List3(['text-center', 'bold', 'text-red'], ['text-center', 'bold', 'text-red']);
exampleList3.render();